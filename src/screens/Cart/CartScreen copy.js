...
const CartScreen = () => {
  ...
  useEffect(() => {
    ...
    let itemPrice = 0;
    axios
      .post('http://10.0.2.2:8000/api/getallcartitems', formdata)
      .then(response => {
  ...
  const handleAddQuantity = e => {
    ...
    axios
      .post('http://10.0.2.2:8000/api/savequantity', formdata)
      .then(response => {
        console.log(response.data);
      });
  };
  ...
  const checkOut = () => {
    ...
    if (!date) {
      ...
      axios
        .post('http://10.0.2.2:8000/api/checkout', formdata)
        .then(response => {
          console.log(response.data);
          Alert.alert(
            'Order For Review!',
  ...
  const removeToCart = id => {
    ...
    axios
      .post('http://10.0.2.2:8000/api/removetocart', formdata)
      .then(response => {
        console.log(response.data);
        Alert.alert(
          'Item Removed!',
